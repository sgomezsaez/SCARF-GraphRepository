...
@XmlRootElement(name = "ConcreteNodeList")
public class ConcreteNodeOutput {

    protected List<ConcreteNodeOutput.Specification> specification;
     ...
     * 
     */
    public List<ConcreteNodeOutput.Specification> getSpecification() {
        if (specification == null) {
            specification = new ArrayList<ConcreteNodeOutput.Specification>();
        }

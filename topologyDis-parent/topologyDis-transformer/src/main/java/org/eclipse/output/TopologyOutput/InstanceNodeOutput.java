...
@XmlRootElement(name = "InstanceNodeList")
public class InstanceNodeOutput {

    protected List<InstanceNodeOutput.Specification> specification;
     ...
     * 
     */
    public List<InstanceNodeOutput.Specification> getSpecification() {
        if (specification == null) {
            specification = new ArrayList<InstanceNodeOutput.Specification>();
        }

...
@XmlRootElement(name = "MuTopologList")
public class MuTopologyOutput {

    protected List<MuTopologyOutput.Specification> specification;
     ...
     * 
     */
    public List<MuTopologyOutput.Specification> getSpecification() {
        if (specification == null) {
            specification = new ArrayList<MuTopologyOutput.Specification>();
        }
